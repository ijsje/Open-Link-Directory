...
($hook = get_hook('admin_categories_before_sql_input_check')) ? eval($hook) : null;
//SQL Operations
...
($hook = get_hook('admin_categories_after_sql_input_check')) ? eval($hook) : null;
...
($hook = get_hook('admin_categories_sql')) ? eval($hook) : null;
$result = $db->query_build($query) or error("can't dig categories", __FILE__, __LINE__);

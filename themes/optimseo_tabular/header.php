...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr">
	<head>
		...
		<script type="text/javascript" src="include/scriptlayer/jquery.js"></script>
		<script type="text/javascript" src="<?php echo $settings['domain']. "/themes/" .$settings['template_path']. "script.js"; ?>"></script>
		<script type="text/javascript" src="<?php echo $settings['domain']. "/themes/" .$settings['template_path']. "pretty.js"; ?>"></script>

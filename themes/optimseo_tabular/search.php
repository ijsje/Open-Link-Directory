...
<form action="<?php echo $settings['domain']. '/search.php'; ?>" accept-charset="utf-8" method="get">
	<label><?php echo SEARCH_FOR; ?> 
	<input type="text" value="" name="term" /></label>
	<br />
	<br />
	<table cellspacing="0" summary="">
		...
		<tbody>
			<tr>
				<td>
					<label><input type="radio" name="search_in" value="title" checked="checked" />
					<?php echo TITLE_LABEL; ?></label>
					<br />
					<label><input type="radio" name="search_in" value="description"/>
					<?php echo DESCRIPTION_LABEL; ?></label>
					<br />
				</td>
				<td>
					<label><input type="radio" name="sort_by" value="alphabetical" checked="checked" />
					<?php echo ALPHABETICAL_LABEL; ?></label>
					<br />
					<label><input type="radio" name="sort_by" value="alphabetical_reversed" />
					<?php echo ALPHABETICAL_REVERSED; ?></label>
					<br />
					<label><input type="radio" name="sort_by" value="newest_first" />
					<?php echo NEWEST_FIRST; ?></label>
					<br />
					<label><input type="radio" name="sort_by" value="oldest_first" />
					<?php echo OLDEST_FIRST; ?></label>
					<br />
				</td>
				<td>
					<label><input type="radio" name="search_type" value="links" checked="checked" />
					<?php echo LINKS_LABEL; ?></label>
					<br />
					<label><input type="radio" name="search_type" value="categories" />
					<?php echo CATEGORY_LABEL; ?></label>
					<br />
				</td>
			</tr>
		</tbody>
	...
	<tbody class="hasicon">
		...
		<tr>
			<td class="tcl">
				...
				<p><?php echo openld_htmlspecialchars($row['description']); ?></p>

				<p class="crumb">
					<?php echo CATEGORY_LABEL . display_navbar(!empty($row['father_id']) ? $row['id'] : $row['category_id']); ?>
				</p>

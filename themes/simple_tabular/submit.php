	...
	<table>
		<?php if($settings['sponsor_links_option']=='Y') {
			...
			$sponsor_checked = 'checked="checked"';
				...
				$sponsor_checked = '';
			?>
			<tr><td><input type='radio' value='sponsor' name='linktype' <?php echo $sponsor_checked; ?> />
			<?php echo SPONSOR_LINK; ?> - <?php echo $sponsor_price; ?><?php ($hook = get_hook('sponsor_information')) ? eval($hook) : null; ?></td></tr>
		<?php } if($settings['paid_links_option']=='Y') {
			...
			<tr><td><input type='radio' value='paid' name='linktype' <?php echo $paid_checked; ?> />
			<?php echo PAID_LINK; ?> - <?php echo $paid_price; ?></td></tr>
		<?php } if($settings['reciprocal_links_option']=='Y') {
			...
			?>
			<tr><td><input type='radio' value='reciprocal' name='linktype' <?php echo $reciprocal_checked; ?> />
			<?php echo RECIPROCAL_LINK; ?></td></tr>
		<?php } if($settings['regular_links_option']=='Y') { ?>
			<tr><td><input type='radio' value='regular' name='linktype' checked="checked" />
			<?php echo REGULAR_LINK; ?></td></tr>
		<?php } ?>
		<tr>
			<td width="100px">

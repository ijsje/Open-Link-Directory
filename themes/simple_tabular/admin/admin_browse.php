...
<div class="navigation">
	...
	<a class="category-link" href="<?php echo $settings['domain']. '/admin_browse.php'; ?>"><?php echo $settings['title']; ?></a>
...
<h2>
	...
	<?php ($hook = get_hook('admin_browse_before_categories_if')) ? eval($hook) : null;
			...
			<tbody>
				...
				<tr<?php echo ($links['type']=='d' ? ' class="openld-sponsor-cell"' : ''); ?>>
					...
					<td>
						...
						<?php echo SUBMITTED_LABEL; ?> <?php $links['date_submitted'] ?><br />

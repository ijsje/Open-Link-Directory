			...
			<div class="panel">
				<table>
					...
					<tr>
						...
						<td>
							<textarea name="description" rows="1" cols="75"><?php echo (isset($_POST['description']) ? openld_htmlspecialchars($_POST['description']) : ''); ?></textarea>
							<br />
						...
						<td>
							<select name="id">
								...
								<?php foreach($cats as $cat) { ?>
									<option value="<?php echo $cat['id']; ?>"<?php echo (($cat['id'] == (isset($_GET['id']) ? $_GET['id'] : "0")) ? ' selected="selected"' : ''); ?>>

<div class="navigation">
	...
	<a class="category-link" href="<?php echo openld_htmlspecialchars($settings['domain']); ?>"><?php echo openld_htmlspecialchars($settings['title']); ?></a>
...
<table cellspacing="0" summary="">
	...
	<td>
		...
		<a class="category-link" href="<?php echo $category_link; ?>"><?php echo openld_htmlspecialchars($category['title']); ?></a><?php ($hook = get_hook('ccc_after_link')) ? eval($hook) : null; ?><br />
		<?php ($hook = get_hook('categories_category_cells_footer')) ? eval($hook) : null; ?>
	</td>
	<?php if($colums_while == $settings['number_of_colums'])
	{
		$colums_while = 0;
		echo '</tr>';
	}

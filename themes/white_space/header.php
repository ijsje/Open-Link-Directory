			...
			<div class="header">
				...
				<div class="menu-block">
					<ul>
						...
						<?php if($settings['hide_admin_button'] == 'N') { ?>
							<li><a href="<?php echo $settings['domain']; ?>/admin_information.php"><?php echo ADMIN_LABEL; ?></a></li>
						<?php } ?>
						...
						<li><a href="<?php echo $settings['domain']; ?>/search.php"><?php echo SEARCH_LABEL; ?></a></li>

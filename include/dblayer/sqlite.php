...
if (!function_exists('sqlite_open'))
	exit('This PHP environment doesn\'t have SQLite support built in. SQLite support is required if you want to use a SQLite database to run this directory. Consult the PHP documentation for further assistance.');
...
class DBLayer
{
	...
	{
		// Prepend $db_name with the path to the directory root directory
		$db_name = OPENLD_ROOT.$db_name;
	...
	{
		return is_array($arr) ? array_map(array(&$this, 'escape'), $arr) : $this->escape($arr);
	}

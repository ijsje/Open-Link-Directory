...
if (!function_exists('mysqli_connect'))
	exit('This PHP environment doesn\'t have Improved MySQL (mysqli) support built in. Improved MySQL support is required if you want to use a MySQL 4.1 (or later) database to run this directory. Consult the PHP documentation for further assistance.');
...
class DBLayer
{
	...
	function DBLayer($db_host, $db_username, $db_password, $db_name, $db_prefix, $foo)
	{
		...
		if (!defined('OPENLD_NO_SET_NAMES'))
			$this->set_names('utf8');
